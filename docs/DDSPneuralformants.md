...
![Neural formant pipeline follwing the source-filter model architectrue](./images/DDSPND_Diagram.png "Neural formant pipeline follwing the source-filter model architectrue.")